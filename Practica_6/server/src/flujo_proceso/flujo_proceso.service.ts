...
// import { CreateFlujoProcesoDto } from './dto/inputs/create-flujo_proceso.dto';
// import { UpdateFlujoProcesoDto } from './dto/inputs/update-flujo_proceso.dto';
// import {
//   FlujoProceso,
//   FlujoProcesoDocument,
// } from './schema/flujo_proceso.schema';

// @Injectable()
// export class FlujoProcesoService {
//   constructor(
//     @InjectModel(FlujoProceso.name)
//     private flujoProcesoModel: Model<FlujoProcesoDocument>,
//   ) {}
...
//         `El flujo de proceso con el nombre "${name}" ya existe.`,
//       );
//     }
//     //TODO Falta verificar la existencia de las id de las referencias
//     const flujoProcesoCreate = await this.flujoProcesoModel.create(
//       createFlujoProcesoDto,
//     );
//     return flujoProcesoCreate;
//   }

//   async findAllFlujoProceso() {
//     const flujoProcesoFindAll = await this.flujoProcesoModel
//       .find({})
...
//         `El flujo de proceso que desea consultar con la id "${id}" no existe.`,
//       );
//     }
//     return flujoProcesoFindById;
//   }

//   async updateFlujoProceso(
//     id: string,
//     updateFlujoProcesoDto: UpdateFlujoProcesoDto,
//   ) {
...
//       );
//     }
//     const flujoProcesoUpdate = await this.flujoProcesoModel.findByIdAndUpdate(
//       id,
//       updateFlujoProcesoDto,
//     );
...
//     if (!flujoProcesoExist) {
//       throw new NotFoundException(
//         `El flujo de proceso que desea eliminar con la id "${id}" no existe.`,
//       );
//     }
//     const flujoProcesoRemove = await this.flujoProcesoModel.findByIdAndDelete(
//       id,
//     );
...
export class FlujoProcesoService {
  constructor(
    @InjectModel(FlujoProceso.name)
    private readonly procesoModel: Model<FlujoProceso>,
  ) {}

  async create(
    createFlujoProcesoInput: CreateFlujoProcesoInput,
  ): Promise<FlujoProceso> {
    const newFlujoProceso = await this.procesoModel.create(
      createFlujoProcesoInput,
    );
    return newFlujoProceso.save();
  }
